        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <select name="brand_id" id="" class="form-control selectpicker" data-live-search="true">
                                    <option value="" selected disabled>Select A Brand</option>
                                    <?php if(!empty($all_brands)) foreach($all_brands as $row){ ?>
                ...
                <table class="table table-bordered">
                    ...
                    <?php if(!empty($brands)){ foreach($brands as $key => $row){ ?>
                    <tr>
                        <td><?=(++$key)?></td>
                        <td><?=($row->brand)?></td>
