        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class="panal-header-title ">
                    <h1 class="pull-left">Action Menus Alignment</h1>
                </div>
            </div>
                                ...
                                <div class="items" data-id="<?php echo $value->id; ?>">
                                    ...
                                    <div class="dropdown_name">
                                        <?php
                                            ...
                                            $dropdown = read('system_aside_menu_dropdowns',['id'=>$dropdown_id, 'status'=>1]);
                                            echo ($dropdown) ? $dropdown[0]->name : '';
                                        ?>
...
<script>
    ...
    function updatePosition() {
        ...
        xhttp.open("POST", "<?php echo site_url('system_aside_menu/ActionMenuController/ajax_alignment_process'); ?>", true);
