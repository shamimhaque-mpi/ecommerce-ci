...
<div class="panel panel-default">
    ...
    <div class="panel-body" ng-controller="editPurchaseController">
        <form action="" method="POST">
            <div class="row">
            	<div class="col-md-3">
					<div class="form-group">
	            		<select class="form-control selectpicker" ng-model="product_id" data-live-search="true">
            ...
            <input type="hidden" ng-value="supplier_id" name="supplier_id">

            <hr>

            <div class="row" ng-cloak>
            	<div class="col-md-9">
            		<table class="table table-bordered items" ng-init="sap_record_id=<?=($sap_record_id)?>">
            			<tr>
            				<th width="50">SL</th>
                ...
                <div class="col-md-3 custom-border">
                    <div class="supplier_info">
						...
						<div ng-show="!supplier" class="form-group">
							...
							<input class="form-control" name="supplier_name" ng-value="supplier_name" type="text" ng-required="!supplier" readonly>
						</div>
                    </div>
                    <hr>
                    <div>
