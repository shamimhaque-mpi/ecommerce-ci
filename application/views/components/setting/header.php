...
<div class="panel panel-default">
    ...
    <div class="panel-body" style="position: relative;">
        <form action="<?php echo get_url("setting/setting/set_apk"); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-md-2 control-label">APK <span class="req">*</span></label>
                <div class="col-md-5">
            ...
            <?php echo isset($header[0]->apk) ? $header[0]->apk : ''; ?>
        </form>
    </div>
    <div class="panel-footer">&nbsp;</div>
</div>
